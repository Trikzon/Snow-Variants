...
public class ModBlocks {
    ...
    public static final VariantStairs SNOW_STONE_BRICK_STAIRS = new VariantStairs(Blocks.STONE_BRICK_STAIRS, Blocks.STONE_BRICK_STAIRS, new ItemStack(Blocks.SNOW), SoundType.SNOW, createBlockProperties(Material.ROCK, 1.5f, 1.5f, SoundType.STONE));
